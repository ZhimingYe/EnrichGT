...
``` r
re_enrichment_results <- egt_recluster_analysis(res_from_ora)
# Show gt table
re_enrichment_results@gt_object
```

The `gt_object` is a pure object of `gt` package, you can use any [function](https://gt.rstudio.com/articles/gt.html) on it, like:
